# WinSonic.Subsonic.Client.Model.GetSonicSimilarTracksSuccessResponse
...
**Status** | **string** | The command result. &#x60;ok&#x60; | 
**SonicMatch** | [**List&lt;SonicMatch&gt;**](SonicMatch.md) | A list of similar tracks with similarity values. | 
