# WinSonic.Subsonic.Client.Model.NowPlayingEntry
...
**MinutesAgo** | **int** | Last update | 
**PlayerId** | **int** | Player Id | 
**PlayerName** | **string** | Player name | [optional] 
**State** | **string** | Playback state. | [optional] 
**PositionMs** | **int** | Current playback position in milliseconds (Calculated by the server from the last playbackReport call received) | [optional] 
**PlaybackRate** | **float** | Playback speed multiplier | [optional] 
