...
namespace WinSonic.Subsonic.Client.Model
{
    ...
    /// SubsonicError
    /// </summary>
    [DataContract(Name = "SubsonicError")]
    public partial class SubsonicError : IValidatableObject
    {
        /// <summary>
        ...
        public SubsonicError(CodeEnum code = default, string message = default, string helpUrl = default)
        {
            this.Code = code;
